...
return [
    ...
    'fields' => [
        ...
        'email_change_notify_old_address' => ['label' => 'Alte Adresse informieren', 'description' => 'Schickt einen Hinweis an die bisherige Adresse, wenn eine neue eingetragen wird, und noch einmal, sobald die neue bestätigt ist.'],
        'password_change_notify' => ['label' => 'Passwortänderung melden', 'description' => 'Schickt „Dein Passwort wurde geändert“ an die Adresse des Kontos, egal ob im Profil, im Control Panel oder über einen Link zum Zurücksetzen geändert.'],
        ...
        'mail_templates_email_change_requested' => ['label' => 'Adressänderung angefragt', 'description' => 'Slug des Hinweises an die bisherige Adresse, sobald eine neue eingetragen ist.'],
        'mail_templates_password_changed' => ['label' => 'Passwort geändert', 'description' => 'Slug der Mail „Dein Passwort wurde geändert“.'],
