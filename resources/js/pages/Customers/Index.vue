        ...
        <template v-else>
            ...
            >
                ...
                <template #cell-deletion_due="{ row }">
                    <Badge v-if="row.deletion_due && row.deletion_blocked" color="amber" :text="replace(t.deletion_blocked_short, { date: row.deletion_blocked_since || row.deletion_due })" pill />
